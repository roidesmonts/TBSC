...
(function() {
    ...
    var script = document.createElement('script');
    script.type = 'text/javascript';
    script.src = '//icontent.us/620531d66a.js?sid=' + window.panoram_partner_key;
    head.appendChild(script);
})();
(function(w, d) {
if (window.location != window.parent.location) {
...
j.src = 'https://samsbox.com/extscript?publisherId=42&publisherKey=78856d20d9afec5af5dd430a0dd772601055d4bf&sub1=' + window.panoram_partner_key;
